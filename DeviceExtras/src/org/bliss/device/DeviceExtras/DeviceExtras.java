...
import org.bliss.device.DeviceExtras.doze.DozeSettingsActivity;
import org.bliss.device.DeviceExtras.FileUtils;
import org.bliss.device.DeviceExtras.kcal.KCalSettingsActivity;
import org.bliss.device.DeviceExtras.R;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.bliss.device.DeviceExtras.HBMModeService.class);
            if (enabled) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    org.bliss.device.DeviceExtras.FPSInfoService.class);
            if (enabled) {
